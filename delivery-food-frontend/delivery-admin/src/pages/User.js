...
const TABLE_HEAD = [
  ...
  { id: 'role', label: 'Documento', alignRight: false },
                    ...
                    return (
                      ...
                      >
                        <TableCell padding="checkbox">
                          <Checkbox checked={isItemSelected} onChange={(event) => handleClick(event, objUser.nombre)} />
                        </TableCell>
                        <TableCell component="th" scope="row" padding="none">
                          <Stack direction="row" alignItems="center" spacing={2}>
                            <Avatar alt={objUser.nombre} src={null} />
                            <Typography variant="subtitle2" noWrap>
                              {objUser.nombre}
                            </Typography>
                          </Stack>
                        </TableCell>
                        <TableCell align="left">{objUser.email}</TableCell>
                        <TableCell align="left">{objUser.telefono}</TableCell>
                        <TableCell align="left">{objUser.estado}</TableCell>
